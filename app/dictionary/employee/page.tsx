          ...
          <PPOAccordion>
            ...
            <PPOAccordionDetails>
              <div className="flex flex-col gap-5">
                <div>
                  <p>
                    <span className="font-semibold">Материальная помощь может
                ...
                <div>
                  ...
                  <p>
                    - Рождение ребёнка (усыновление (удочерение)/установление опеки и попечительства)
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    физической культурой и спортом (бассейн, тренажёрный зал, спортивный клуб и т.п.)
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p>
                    - Приобретение дорогостоящих медицинских препаратов и лечебного оборудования (лечебных материалов)
                  </p>
                  <p>
                  ...
                  <p>
                    - Возникновение у работника критических обстоятельств (кража, пожар, затопление и т.д.)
                  </p>
                  <p>
                  ...
                  <p>
                    - Помощь ветеранам и участникам ВОВ, одиноким и неработающим пенсионерам-членам Профсоюза
                  </p>
                  <p>
          ...
          <PPOAccordion>
            ...
            <PPOAccordionDetails>
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <p>
                    - В федеральном государственном бюджетном образовательном учреждении высшего образования
                    {' '}
                    <span className="font-semibold">«Московский государственный технический университет «МАМИ»</span>
                  </p>
                  <p>
                    - В федеральном государственном образовательном учреждении среднего профессионального образования
                    {' '}
                  ...
                  <p>
                    - В Электростальском политехническом институте (филиале) федерального государственного
          ...
          <PPOAccordion>
            ...
            <PPOAccordionDetails>
              <div className="flex flex-col gap-5">
                ...
                <div>
                  <p>
                    <a href="https://www.profkurort.ru/unions/" className="underline underline-offset-2" target="_blank">Льготные путевки в санаторий членам профсоюзов (ФНПР)</a>
                  </p>
                </div>
              </div>
            </PPOAccordionDetails>
              ...
              <div className="flex flex-col gap-5">
                <div>
                  <p>
                    ...
                    Подробнее:
                    {' '}
                    <a href="https://kurort.by" className="underline underline-offset-2" target="_blank">https://kurort.by</a>
                  </p>
                </div>
              </div>
            </PPOAccordionDetails>
            ...
            <div className="flex flex-col gap-5">
              <div>
                <p>
                  ...
                  {' '}
                  <a href="https://profplus.info" className="underline underline-offset-2" target="_blank">https://profplus.info</a>
                </p>
              </div>
            </div>
          </PPOAccordionDetails>
